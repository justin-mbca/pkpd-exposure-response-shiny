...
**Interpretation:** Response rates increase across Cmax quartiles,
supporting an exposure-response relationship.

## Figures

![Boxplot of Cmax](boxplot_cmax.png) ![Exposure-Response
Scatter](exposure_response_scatter.png) ![Kaplan-Meier
Curve](km_curve.png) ![AE Rate by Dose](ae_rate_dose.png) ![AE Rate by
Exposure Quartile](ae_rate_expq.png)
...
**Missing Exposure** \| USUBJID \| Cmax \| AUC \|
\|---------\|------\|-----\| \| 0 \| 0 \| 0 \|

**Outliers** \| USUBJID \| Cmax \| AUC \| \|---------\|------\|-----\|
\| *(none)*\| \| \|
